...
Drivers/iwdg/%.o Drivers/iwdg/%.su Drivers/iwdg/%.cyclo: ../Drivers/iwdg/%.c Drivers/iwdg/subdir.mk
...
clean: clean-Drivers-2f-iwdg

clean-Drivers-2f-iwdg:
	-$(RM) ./Drivers/iwdg/iwdg.cyclo ./Drivers/iwdg/iwdg.d ./Drivers/iwdg/iwdg.o ./Drivers/iwdg/iwdg.su

.PHONY: clean-Drivers-2f-iwdg
